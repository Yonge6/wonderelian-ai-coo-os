...
const emptyState=()=>({metadata:{schema_version:"1",last_updated:""},apps:[],metrics:[],channels:[],campaigns:[],content:[],insights:[],actions:[],feedback:[],opportunities:[],experiments:[],providers:[],jobs:[],events:[],audit:[]});
