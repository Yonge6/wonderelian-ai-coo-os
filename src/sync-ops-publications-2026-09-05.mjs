...
await store.mutate((state) => {
  const auditId = "audit-ops-publications-20260905";
  ...
  state.audit.unshift({
    ...
    action: "sync_verified_publication_urls_2026_09_05",
    input: { external_writes: false, operation_date: "2026-09-05" },
    result: {
      status: "success",
      records_inserted: 0,
      verified_business_publication_urls: 0,
      operational_dashboard_urls_excluded_from_content: 2,
...
console.log("OPS_PUBLICATIONS_20260905_SYNC_OK inserted=0 content_unchanged=true");
