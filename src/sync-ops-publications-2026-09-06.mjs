...
await store.mutate((state) => {
  const auditId = "audit-ops-publications-20260906";
  ...
  state.audit.unshift({
    ...
    action: "sync_verified_publication_urls_2026_09_06",
    input: { external_writes: false, operation_date: "2026-09-06" },
    result: {
      status: "success",
      records_inserted: 0,
      verified_business_publication_urls: 0,
      operational_site_and_dashboard_urls_excluded_from_content: 3,
...
console.log("OPS_PUBLICATIONS_20260906_SYNC_OK inserted=0 content_unchanged=true");
