...
await store.mutate((state) => {
  const auditId = "audit-ops-publications-20260909";
  ...
  state.audit.unshift({
    ...
    action: "sync_verified_publication_urls_2026_09_09",
    input: { external_writes: false, operation_date: "2026-09-09" },
    result: {
      status: "success",
      records_inserted: 0,
...
console.log("OPS_PUBLICATIONS_20260909_SYNC_OK inserted=0 content_unchanged=true");
