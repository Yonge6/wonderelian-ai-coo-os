...
await store.mutate((state) => {
  const auditId = "audit-ops-publications-20260910";
  ...
  state.audit.unshift({
    ...
    action: "sync_verified_publication_urls_2026_09_10",
    input: { external_writes: false, operation_date: "2026-09-10" },
    result: {
      status: "success",
      records_inserted: 0,
...
console.log("OPS_PUBLICATIONS_20260910_SYNC_OK inserted=0 content_unchanged=true");
