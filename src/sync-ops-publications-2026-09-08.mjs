...
await store.mutate((state) => {
  const auditId = "audit-ops-publications-20260908";
  ...
  state.audit.unshift({
    ...
    action: "sync_verified_publication_urls_2026_09_08",
    input: { external_writes: false, operation_date: "2026-09-08" },
    result: {
      status: "success",
      records_inserted: 0,
...
console.log("OPS_PUBLICATIONS_20260908_SYNC_OK inserted=0 content_unchanged=true");
